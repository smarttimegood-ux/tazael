      ...
      <section className="px-6 py-12 md:py-20 max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <p className="text-lg text-foreground/70 mb-8 leading-relaxed max-w-xl">
            {L
              ? "Кеңес: Айналаңыздағы экологиялық мәселелерді тіркеп, Маңғыстаудың табиғатын бірге қорғайық. Әрбір репорт — облысымыздың таза болашағына қадам."
              : "Совет: Отмечайте экологические проблемы вокруг вас и вместе защищайте природу Мангистау. Каждый репорт — шаг к чистому будущему региона."}
          </p>
