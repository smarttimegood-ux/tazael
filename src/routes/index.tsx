      ...
      <section className="py-24 px-6 max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            ...
            { n: "02", t: L ? "AI жіктейді" : "ИИ классифицирует", d: L ? "Lovable AI категория мен қауіптілікті анықтап, әкімдікке нақты ұсыныс береді." : "Lovable AI определяет категорию, тяжесть и даёт рекомендацию." },
